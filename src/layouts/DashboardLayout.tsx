...
const DashboardLayout = () => {
  ...
  const { role, roleLoading, isUser, isAdmin, isCharity, isRestaurant } =
    useUserRole();
  useEffect(() => {
    if (user?.email) {
    ...
    <section className="drawer lg:drawer-open">
      ...
      <div className="drawer-side shadow-[4px_0px_10px_rgba(0,0,0,0.2)] z-10">
        ...
        <ul className="menu bg-teal-100/50 border border-gray-500/50  text-base-content min-h-full w-80 p-4">
          ...
          <Link to="/">
            <button className="btn bg-teal-200 text-3xl italic text-gray-700 shadow-inner border border-gray-400/50 cursor-pointer mb-6 w-full">
              flexora{" "}
            </button>
          </Link>
          ...
          {!roleLoading &&
            (role === "restaurant_role_request" ||
              ...
              <li className="shadow-md mb-3 shadow-orange-200 bg-teal-200">
                <NavLink
                  to="/dashboard/profile_user_common"
          ...
          {!roleLoading && isUser && (
            <>
              ...
              <li className="shadow-md mb-3 shadow-orange-200 bg-teal-200">
                <NavLink
                  to="/dashboard/request_charity_role"
                  className="flex items-center gap-2"
                >
              ...
              <li className="shadow-md mb-3 shadow-orange-200 bg-teal-200">
                <NavLink
                  to="/dashboard/request_restaurant_role"
                  className="flex items-center gap-2"
                >
              ...
              <li className="shadow-md mb-3 shadow-orange-200 bg-teal-200">
                <NavLink
                  to="/dashboard/transaction_history_user"
                  className="flex items-center gap-2"
                >
          ...
          {!roleLoading && isAdmin && (
            <>
              ...
              <li className="shadow-md mb-3 shadow-orange-200 bg-teal-200">
                <NavLink
                  to="/dashboard/manage_role_requests"
                  className="flex items-center gap-2"
                >
              ...
              <li className="shadow-md mb-3 shadow-orange-200 bg-teal-200">
                <NavLink
                  to="/dashboard/manage_donations"
                  className="flex items-center gap-2"
                >
                  <FaGift className="text-xl text-green-700" />{" "}
                  {/* or another icon you prefer */}
                  Manage Donations
                </NavLink>
              </li>
              <li className="shadow-md mb-3 shadow-orange-200 bg-teal-200">
                <NavLink
                  to="/dashboard/feature_donations"
                  className="flex items-center gap-2"
                >
          ...
          {!roleLoading && isRestaurant && (
            <>
              <li className="shadow-md mb-3 shadow-orange-200 bg-teal-200">
                <NavLink
                  to="/dashboard/profile_restaurant"
                  className="flex items-center gap-2"
                >
                  <FaUser className="text-xl text-blue-600" />
                  My Profile
              ...
              <li className="shadow-md mb-3 shadow-orange-200 bg-teal-200">
                <NavLink
                  to="/dashboard/restaurant_profile"
                  className="flex items-center gap-2"
                >
              ...
              <li className="shadow-md mb-3 shadow-orange-200 bg-teal-200">
                <NavLink
                  to="/dashboard/restaurant_donation_stats"
                  className="flex items-center gap-2"
                >
          ...
          {!roleLoading && isCharity && (
            <>
              ...
              <li className="shadow-md mb-3 shadow-orange-200 bg-teal-200">
                <NavLink
                  to="/dashboard/transaction_history_charity"
                  className="flex items-center gap-2"
                >
                  <FaRegMoneyBillAlt className="text-xl text-green-600" />
                  Transaction History
              ...
              <li className="shadow-md mb-3 shadow-orange-200 bg-teal-200">
                <NavLink
                  to="/dashboard/my_favorites_charity"
                  className="flex items-center gap-2"
                >
                  <FaHeart className="text-xl text-orange-500" />
                  My Favorites
