...
interface ICardCharityRequestProps {
  request: DonationRequest;
}
const CardCharityRequest = ({ request }: ICardCharityRequestProps) => {
  return (
    <section className="card bg-gray-200 shadow-xl">
      ...
      <div className="card-body">
        ...
        <p>
          {" "}
          <span className="two">Food Donation Title :</span>{" "}
          <span className="text-black">{request?.donation_title}</span>
        </p>
        <p>
          {" "}
          <span className="two">Charity Representative :</span>{" "}
